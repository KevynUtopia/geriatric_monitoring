...
def download_gaze_tensorflow_models():
    request_if_not_exist(
        os.path.join(os.path.dirname(os.path.realpath('__file__')), 'weights/Model_allsubjects1.h5'),
...
def download_blink_tensorflow_models():
    request_if_not_exist(os.path.join(os.path.dirname(os.path.realpath('__file__')), 'weights/blink_model_1.h5'),
                         "https://imperialcollegelondon.box.com/shared/static/lke3k5f86qnfchzfh6lpon3isniqvkpz.h5",
                         "75aab57645faed3beaba5dedfd0f3d36")
    request_if_not_exist(os.path.join(os.path.dirname(os.path.realpath('__file__')), 'weights/blink_model_2.h5'),
...
def download_blink_pytorch_models():
    request_if_not_exist(os.path.join(os.path.dirname(os.path.realpath('__file__')), 'weights/blink_model_pytorch_vgg16_allsubjects1.model'),
...
def download_external_landmark_models():
    request_if_not_exist(
        os.path.join(os.path.dirname(os.path.realpath('__file__')), 'weights/ThreeDDFA/w_shp_sim.npy'),
        'https://github.com/cleardusk/3DDFA/blob/master/train.configs/w_shp_sim.npy?raw=true',
        '74d41d465580924456defd99401cfcdd')
    request_if_not_exist(
        os.path.join(os.path.dirname(os.path.realpath('__file__')), 'weights/ThreeDDFA/w_exp_sim.npy'),
        'https://github.com/cleardusk/3DDFA/blob/master/train.configs/w_exp_sim.npy?raw=true',
        '7566556b7760b8691f3a6fddbdd38fcc')
    request_if_not_exist(
        os.path.join(os.path.dirname(os.path.realpath('__file__')), 'weights/phase1_wpdc_vdc.pth.tar'),
    ...
    request_if_not_exist(
        os.path.join(os.path.dirname(os.path.realpath('__file__')), 'weights/SFD/s3fd_facedetector.pth'),
        "https://imperialcollegelondon.box.com/shared/static/wgfkq3pyzzuewiiwq0pzj0xiebolvlju.pth",
        "3b5a9888bf0beb93c177db5a18375a6c")

    request_if_not_exist(
        os.path.join(os.path.dirname(os.path.realpath('__file__')), 'weights/dlib_face_recognition_resnet_model_v1.dat'),
