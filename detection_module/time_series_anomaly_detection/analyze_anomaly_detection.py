...
from system_enging import SystemEngine
...
def plot_anomaly_detection_results(csv_path, ad_results, anomaly_scores, timestamps, output_dir, filename):
    ...
    plot_output_path = os.path.join(output_dir, f'{filename}.png')
...
def process_directory(directory_path):
    ...
    for csv_file in sorted(csv_files):
        ...
        if DEBUG_MODE:
            csv_file = '/Users/kevynzhang/科研工作/SNH/TSAD_DATASET/ts_recording_2019_06_22_9_20_am_p_5.csv'
