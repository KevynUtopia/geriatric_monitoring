...
if __name__ == "__main__":
    ...
    # Create model
    model = LSTMModel(window_size=window_size, input_size=input_size,
                 hidden_dim=hidden_dim, pred_len=pred_len,
                      num_layers=num_layers, batch_size=batch_size, device=device).to(device)
