...
def main():
    ...
    print("original video size:", w, h)

    # resize frames to shortside
    args.short_side = 256
    print('Resizing frames to short side:', args.short_side)
    new_w, new_h = mmcv.rescale_size((w, h), (args.short_side, np.Inf))
    frames = [mmcv.imresize(img, (new_w, new_h)) for img in original_frames]
    w_ratio, h_ratio = new_w / w, new_h / h
    print('Resized video size:', new_w, new_h)
    ...
    print('clip_len:', clip_len, 'frame_interval:', frame_interval)

    # clip_len, frame_interval = 4, 2
    ...
    print(len(timestamps), 'timestamps:', timestamps)
    exit(0)
    ...
    print('center_frames:', center_frames)
    ...
    print(human_detections[0].shape)
    ...
    for human_detection, prediction in zip(human_detections, predictions):
        print(human_detection.shape, prediction)
